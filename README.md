...
This is a part of [test expressions](test-data.nix). This case is implemented [here](https://github.com/br4ch1st0chr0n3/devops-labs/blob/80978ecd1826548904e442e5fb428f2127748be7/.nix/terraform/docker.nix#L62). The below Nix snippets are in `let in` blocks to have better syntax highlighting.
