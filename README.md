...
1. Learn about a command:
   ...
   ```nix
   {
       ...
       inputs.nixpkgs.url = github:NixOS/nixpkgs/nixos-1.03;
...
1. There's [dream2nix](https://github.com/nix-community/dream2nix)
   ...
   - I packaged try-phi front end with it, following this [tutorial](https://johns.codes/blog/building-typescript-node-apps-with-nix#dream2nix)

1. How to package a Haskell app - [tutorial](https://www.haskellforall.com/2022/08/incrementally-package-haskell-program.html)

1. Xe's [blog](https://xeiaso.net/blog/nix-flakes-2-2022-02-27)
...
1. [Documentation gaps](https://nixos.wiki/wiki/Documentation_Gaps)
